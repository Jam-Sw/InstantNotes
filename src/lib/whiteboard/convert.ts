...
const CONFIRM = {
  ...
  body: "This note becomes a whiteboard and cannot be converted back to a text document. Copy anything you still need first if you care about the written body.",
